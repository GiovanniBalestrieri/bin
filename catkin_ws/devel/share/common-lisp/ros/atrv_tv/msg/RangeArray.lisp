...
(cl:defmethod cl:initialize-instance :after ((m <RangeArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RangeArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atrv_tv-msg:<RangeArray> is deprecated: use atrv_tv-msg:RangeArray instead.")))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <RangeArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atrv_tv-msg:ranges-val is deprecated.  Use atrv_tv-msg:ranges instead.")
  (ranges m))
